...
new_animal = prompt("Please enter the name of a new animal").toLowerCase()
myAnimals.push(new_animal)
...
alert("The last animal is a/an " + myAnimals[4])

for (myAnimal =0; myAnimals <2;myAnimals++) {
  alert("This last animal is a/an " + myAnimals)
}*/